...
lr = SklearnWrapper(clf=LinearRegression, seed=SEED, params=default_params)
...
print("RDG-CV: {}".format(mean_absolute_error(y_train, rdg_oof_train)))
print("ARD-CV: {}".format(mean_absolute_error(y_train, grd_oof_train)))
print("ADA-CV: {}".format(mean_absolute_error(y_train, ada_oof_train)))


x_train = np.concatenate((xg_oof_train, et_oof_train, rf_oof_train,lr_oof_train,
                          rdg_oof_train, grd_oof_train,ada_oof_train), axis=1)
x_test = np.concatenate((xg_oof_test, et_oof_test, rf_oof_test,lr_oof_test, 
                         rdg_oof_test, grd_oof_test,ada_oof_test), axis=1)
